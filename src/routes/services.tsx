...
export const Route = createFileRoute("/services")({
  head: () => {
    const base = seo({
      ...
      keywords:
        "VIP трансфер Астана цена, почасовая аренда авто с водителем Астана, встреча делегаций Астана, трансфер из аэропорта NQZ, аренда минивэна на день Казахстан, межгород VIP трансфер Казахстан, корпоративный трансфер Астана, Hyundai Staria аренда Астана",
