...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Услуги аренды частного джета в Астане — Private Jet KZ" },
      {
        property: "og:description",
        content:
          "VIP-трансфер, почасовая аренда, встреча делегаций в Астане. Hyundai Staria LUXE. Цены и условия.",
      },
      { property: "og:url", content: "https://privatejetkz.com/services" },
      { rel: "canonical", href: "https://privatejetkz.com/services" },
    ],
  }),
