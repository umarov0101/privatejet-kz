...
export const Route = createFileRoute("/en/services")({
  head: () =>
    seo({
      ...
      keywords:
        "VIP transfer Astana, Astana airport transfer, chauffeur service Astana, executive car service Astana, corporate transfer Astana, business chauffeur Astana, private car service Astana, delegation transport Astana, group transfer Astana, minivan with driver Astana, Astana to Borovoe transfer, Astana to Burabay transfer, Astana to Karaganda private transfer",
      path: "/services",
      locale: "en",
    }),
