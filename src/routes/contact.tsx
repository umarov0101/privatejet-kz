...
export const Route = createFileRoute("/contact")({
  head: () => {
    const base = seo({
      title: "Контакты — VIP-трансфер в Астане | Private Jet KZ",
      description:
      ...
      ogDescription:
        "Заказ VIP-трансфера в Астане на Hyundai Staria LUXE. WhatsApp 24/7: +7 708 938 08 00.",
      path: "/contact",
      locale: "ru",
    });
    return {
      ...base,
      scripts: [{ type: "application/ld+json", children: breadcrumbLd("ru", "contact") }],
    };
  },
