...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Контакты — Private Jet KZ Астана" },
      {
        property: "og:description",
        content: "Заказ VIP-трансфера и аренды в Астане. WhatsApp 24/7: +7 708 938 08 00.",
      },
      { property: "og:url", content: "https://privatejetkz.com/contact" },
      { rel: "canonical", href: "https://privatejetkz.com/contact" },
    ],
  }),
